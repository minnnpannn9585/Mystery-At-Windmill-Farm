...
Shader "ANGRYMESH/Stylized Pack/VFX/VFX WindMesh"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _AnimationFadeSpeed;
			float _AnimationFadeOffset;
			float _CameraDepthFadeDistance;
						 ...
						 ) : SV_Target
			{
				...
				float4 Output_Emissive93 = ( float4( _EmissiveColor , 0.0 ) * input.ase_color * _EmissiveIntensity );
				
				float3 texCoord65 = input.ase_texcoord6.xyz;
				...
				float VColor_Alpha159 = input.ase_color.a;
				...
				float Max_Render_Distance154 = ( 1.0 - clampResult148 );
				float Output_Opacity39 = ( ( saturate( ( ( appendResult90 - appendResult69 ) * appendResult76 ) ).x * ( 1.0 - saturate( ( ( appendResult90 - appendResult69 ) * appendResult76 ) ).x ) ) * Camera_Depth_Fade91 * VColor_Alpha159 * Max_Render_Distance154 * _OpacityIntensity );
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 texCoord65 = input.ase_texcoord3.xyz;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				float3 texCoord65 = input.ase_texcoord.xyz;
...
ASEEND*/
//CHKSM=F6E9A593937FD60D893D4E336C92430CE3B0F545