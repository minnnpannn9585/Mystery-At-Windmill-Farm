...
Shader "ANGRYMESH/Stylized Pack/VFX/VFX TransparentAlpha"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _GeometryDepthFadeDistance;
						 ...
						 ) : SV_Target
			{
				...
				float4 Output_Emissive93 = ( float4( _EmissiveColor , 0.0 ) * input.ase_color * ( _EmissiveIntensity * _EmissiveIntensity ) );
				float2 uv_Opacity103 = input.ase_texcoord6.xy;
				float VColor_Alpha131 = input.ase_color.a;
				...
				float distanceDepth102 = abs( ( screenDepth102 - LinearEyeDepth( ase_positionSSNorm.z,_ZBufferParams ) ) / ( _GeometryDepthFadeDistance ) );
...
ASEEND*/
//CHKSM=67753CF276F7042EF7BC239A1433BA53EFECB725